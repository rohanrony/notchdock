...
- **Visible Calendars**: A list of all discovered system calendars (Work, Personal, etc.) with toggles to enable or disable them in Notchlet. 
...
| `CalendarModule` | `NotchletExtension` conformance |
