# Notchlet Validation Prompts

## Validate one spec
```text
Review this Notchlet spec document for clarity, contradictions, and missing details.
...
```text
Review the full Notchlet spec set for internal consistency.
