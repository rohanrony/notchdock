# NotchDock Settings Specification

This document defines the structure, design, and functionality of the NotchDock settings window.
...
### 4.2 Module Protocol (`NotchDockExtension`)
```swift
