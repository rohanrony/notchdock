# NotchDock Modular Build Prompts

## Phase 0
```text
Build the NotchDock project skeleton in Swift and SwiftUI.

Requirements:
- Create the app structure.
- Add NotchDockCore and Extensions directories or modules.
...
## Phase 1
```text
Build the NotchDock host shell and island UI.
...
## Phase 2
```text
Implement the free core modules for NotchDock.
...
## Phase 5
```text
Polish NotchDock animations and visual design.
