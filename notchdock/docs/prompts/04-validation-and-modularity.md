...
3. Check whether the settings popup is the single entry point for installs, payments, and module configuration.
4. Check whether core modules remain free.
5. Check whether AI snippet transformations have been excluded.
