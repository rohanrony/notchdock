# NotchDock Module Addition Guide

## How to add a new module
1. Create a new Swift file under `Extensions/Modules/` (e.g., `MyNewModule.swift`).
2. Implement the shared `NotchDockExtension` protocol.
...
- Put shared UI in NotchDockCore/SharedUI.
- Put shared logic in NotchDockCore.
- Keep free modules usable without payments.
- Keep paid modules easy to unlock and easy to remove.

Extensions/Modules/
└── FocusStatsModule.swift
    ├── struct FocusStatsModule: NotchDockExtension
