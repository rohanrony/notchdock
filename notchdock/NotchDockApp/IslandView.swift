...
struct IslandView: View {
    ...
    func distributeIcons(_ extensions: [any NotchDockExtension]) -> (left: [any NotchDockExtension], right: [any NotchDockExtension], numSlots: Int) {
        ...
        var left: [any NotchDockExtension] = []
        var right: [any NotchDockExtension] = []
    ...
    func moduleIconButton(ext: any NotchDockExtension) -> some View {
        Button(action: {
            withAnimation {
