...
struct TimerModule: NotchDockExtension {
    var id: String = "com.notchdock.timer"
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Your timer settings and history are stored locally. NotchDock operates entirely on your Mac and does not transmit any activity data or usage patterns to external servers.")
