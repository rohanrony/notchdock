...
class ToDoViewModel: ObservableObject {
    ...
    private let storageKey = "com.notchdock.todo.items"
...
struct ToDoModule: NotchDockExtension {
    var id: String = "com.notchdock.todo"
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Your tasks are stored exclusively on your Mac using encrypted local storage. NotchDock does not use any cloud servers, ensuring your data remains private and accessible only to you.")
