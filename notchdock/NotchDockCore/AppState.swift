...
class AppState: ObservableObject {
    ...
    var effectiveCompactExtensionID: String {
        ...
        if TimerViewModel.shared.isCritical {
            return "com.notchdock.timer"
        }
        
        // 2. Calendar Sticky Nudge
        if isNudgeActive {
            return "com.notchdock.calendar"
        }
    ...
    init() {
        ...
        self.activeExtensionID = "com.notchdock.calendar"
    ...
    private func triggerNudge() {
        ...
        if isExpanded || activeExtensionID == "com.notchdock.calendar" { return }
